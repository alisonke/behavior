...
##########################################################################################################
#### Simulation study:										     #####
#### simulate abundance for a community of one species, then generate distance sampling data from that   #####
...
strip.width <- 5 				# strip half-width, w (in this example only one side of the line transect is surveyed) figure out how to change to a circle later
...
mu.s<-log(5)					# mean of species-level random effect on intercept of sigma
...
#  print (iter)
  ...
  modelFile1='Ke_DistanceModel050219.txt'
